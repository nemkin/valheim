...
wget https://gcdn.thunderstore.io/live/repository/packages/Azumatt-AzuExtendedPlayerInventory-1.3.12.zip
...
wget https://gcdn.thunderstore.io/live/repository/packages/ValheimModding-Jotunn-2.18.2.zip
wget https://gcdn.thunderstore.io/live/repository/packages/Digitalroot-Heightmap_Unlimited_Remake-1.4.0.zip
